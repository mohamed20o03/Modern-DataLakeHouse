 ...
 * <ul>
 *   <li>Spark → {@link com.abdelwahab.query_worker.engine.spark.SparkStorageConfigurer}</li>
 *   <li>Flink → its own configurer (future)</li>
 * </ul>
 *
 * <p>Two concrete implementations exist:
 * <ul>
 *   <li>{@link com.abdelwahab.query_worker.storage.minio.MinioStorageConfig} —
 *       local / dev with an explicit endpoint and static key-pair.</li>
 *   <li>{@link com.abdelwahab.query_worker.storage.s3.S3StorageConfig} —
