package com.abdelwahab.ingestion_worker.storage.minio;
 ...
 * {@link com.abdelwahab.ingestion_worker.engine.spark.SparkStorageConfigurer}
 * which writes them as {@code spark.hadoop.fs.s3a.*} Spark config keys.
 *
 * @see com.abdelwahab.ingestion_worker.storage.s3.S3StorageConfig — IAM-based AWS S3 variant
 * @see com.abdelwahab.ingestion_worker.storage.StorageConfigFactory — selects this class
 */
